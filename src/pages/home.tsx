...
function Home() {
  ...
  useEffect(()=>{
    fetch('http://localhost:3000/questions/liveQuestion', {
      method: 'GET',
      headers: {
    ...
    .then(data => {
      if(data && data.length > 0){
        setPollQuestion(data.questionText);
                    ...
                    >
                      ...
                      {hasVoted && (
                        <div
                          ...
                          style={{
                            background: `linear-gradient(90deg, blue40 0%, blue20 100%)`,
                            width: "70%",
                          }}
                        />
                      )}
                      ...
                      <div className="relative flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="relative">
                            <img
                              src="https://images.pexels.com/photos/1618200/pexels-photo-1618200.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop"
                              alt="Team Logo"
